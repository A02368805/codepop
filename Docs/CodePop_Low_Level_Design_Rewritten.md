...
> **What this document is:** the “turn-by-turn directions” for building CodePop on top of the provided base webapp.  
> **What this document is not:** a hand-wavy architecture essay.  
>
> This LLD is intentionally detailed so that:
> 1. a human reviewer can understand the system quickly,
> 2. a teammate can implement one slice at a time without guessing,
> 3. Codex can code against it with fewer wrong assumptions.
