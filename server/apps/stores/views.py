...
class StoreIndexView(TemplateView):
        ...
        context.update(
            {
                ...
                "stores": Store.objects.filter(is_active=True).select_related("region").order_by("name"),
    ...
    def get(self, request, *args, **kwargs):
        ...
        if getattr(request, "htmx", False):
            return render(request, "stores/partials/recommendation_results.html", context)
