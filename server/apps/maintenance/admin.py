...
from .models import Machine, MachineStatusEvent, MachineType, MaintenancePolicy, RepairAssignment
...
class MachineTypeAdmin(admin.ModelAdmin):
    list_display = ("code", "name", "default_service_interval_days", "warning_max_operational_days", "is_active")
...
class MachineAdmin(admin.ModelAdmin):
    list_display = ("machine_uid", "display_name", "store", "machine_type", "current_status", "current_status_date")
...
class MachineStatusEventAdmin(admin.ModelAdmin):
    list_display = ("machine", "status", "status_date", "source_import_job", "created_at")
...
class RepairAssignmentAdmin(admin.ModelAdmin):
    list_display = ("machine", "assigned_to", "store", "priority_score", "status", "scheduled_for")
...
class MaintenancePolicyAdmin(admin.ModelAdmin):
    list_display = ("machine_type", "region", "max_days_between_service", "warning_shutdown_days", "is_active")
