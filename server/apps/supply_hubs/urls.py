...
urlpatterns = [
    ...
    path("transfers/<uuid:transfer_id>/approve/", TransferApproveView.as_view(), name="approve-transfer"),
    path("transfers/<uuid:transfer_id>/reserve/", TransferReserveView.as_view(), name="reserve-transfer"),
    path("transfers/<uuid:transfer_id>/ship/", TransferShipView.as_view(), name="ship-transfer"),
    path("transfers/<uuid:transfer_id>/deliver/", TransferDeliverView.as_view(), name="deliver-transfer"),
    path("transfers/<uuid:transfer_id>/receive/", TransferReceiveView.as_view(), name="receive-transfer"),
    path("schedules/", SupplyScheduleListView.as_view(), name="schedule-list"),
    path("schedules/<uuid:schedule_id>/approve/", SupplyScheduleApproveView.as_view(), name="approve-schedule"),
    path("supplier-orders/", SupplierOrderListView.as_view(), name="supplier-order-list"),
    path("supplier-orders/create/", SupplierOrderCreateView.as_view(), name="create-supplier-order"),
    path(
